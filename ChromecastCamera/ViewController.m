...
//    self.switchLandscape.on = NO;
    ...
    // load switch settings from user model
...
// 01-20-15 - Noticed difference in load speeds of landscape VS portrait images due to aspect fill routine slowing landscape.
